...
public class NotificationConsumer {
	...
	/**
	 * Creates a {@link ThreadPoolExecutor} with a given number of threads to
	 * consume the messages from the broker.
	 * 
	 * @param numberOfThreads
	 *            The number of threads will be used to consume the message
	 */
	public void execute(int numberOfThreads) {

		// Initialize a ThreadPool with size = 5 and use the BlockingQueue with
		// size = 1000 to
